    ...
    >
      <style>{`
        ...
        @keyframes pt-ripple {
          ...
          25%  { opacity: 0.7; }
          70%  { opacity: 0;   transform: translate(-50%, -50%) scale(2.2); border-width: 1px; }
      ...
      <div style={{ position: "relative", width: 0, height: 0 }}>
        ...
        {/* Lime ripple ring expanding outward from center */}
        <div
          style={{
            position: "absolute",
            top: 0,
            ...
            boxShadow: "0 0 22px rgba(200,255,77,0.35)",
            transform: "translate(-50%, -50%) scale(0.2)",
            opacity: 0,
            animation: `pt-ripple ${TOTAL_MS}ms cubic-bezier(0.22, 1, 0.36, 1) forwards`,
            willChange: "opacity, transform",
          }}
        />
        ...
        >
          <img
            ...
            style={{
              ...
              height: "auto",
              opacity: 0,
              filter: "drop-shadow(0 14px 28px rgba(11,106,77,0.32))",
