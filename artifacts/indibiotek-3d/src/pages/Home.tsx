...
export default function Home() {
  ...
  return (
    <div ref={root}>
      {/* ─── HERO ─── */}
      <section
        className="relative min-h-[100vh] flex items-end px-6 md:px-12 pb-20 pt-40"
        style={{
          backgroundImage: `linear-gradient(180deg, rgba(3,19,10,0.40) 0%, rgba(3,19,10,0.55) 50%, rgba(3,19,10,0.95) 100%), url("${HERO_IMG}")`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
        {/* Subtle teal vignette overlay */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse 60% 50% at 80% 30%, rgba(62,230,168,0.18) 0%, transparent 60%), radial-gradient(ellipse 50% 50% at 10% 90%, rgba(90,200,255,0.12) 0%, transparent 60%)",
          }}
        />
        ...
        <div className="relative max-w-6xl mx-auto w-full">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-end">
            ...
            <div className="lg:col-span-4 reveal hidden lg:block">
      ...
      <section className="relative px-6 md:px-12 py-24" style={{ background: "#03130A" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px" style={{ background: "rgba(122,255,212,0.12)", borderRadius: 16, overflow: "hidden", border: "1px solid rgba(122,255,212,0.12)" }}>
            {DIVISIONS.map((d) => (
              <Link key={d.title} href={d.href} data-testid={`card-division-${d.title.toLowerCase().replace(/\s/g, "")}`}>
                <div
                  className="reveal cursor-pointer group transition-all duration-300"
                  style={{
                    padding: 32, height: "100%",
                    background: "linear-gradient(135deg, rgba(20,52,36,0.55) 0%, rgba(8,28,18,0.40) 100%)",
                  }}
                  onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.background = "linear-gradient(135deg, rgba(40,100,72,0.65) 0%, rgba(15,40,28,0.55) 100%)")}
                  onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.background = "linear-gradient(135deg, rgba(20,52,36,0.55) 0%, rgba(8,28,18,0.40) 100%)")}
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                    <div className="font-display" style={{ fontSize: 12, fontWeight: 700, color: "#7AFFD4", letterSpacing: "0.18em" }}>
                      {d.num}
                    </div>
                    <div style={{ width: 8, height: 8, borderRadius: "50%", background: "#7AFFD4", boxShadow: "0 0 12px #7AFFD4" }} />
                  </div>
                  <h3 className="font-display" style={{ fontSize: "1.4rem", fontWeight: 600, color: "#fff", marginBottom: 12, letterSpacing: "-0.01em" }}>
                    {d.title}
                  </h3>
                  <p style={{ color: "rgba(232,245,238,0.62)", fontSize: 14.5, lineHeight: 1.7, fontWeight: 300, marginBottom: 24, minHeight: 60 }}>
                    {d.desc}
                  </p>
                  <span style={{ color: "#7AFFD4", fontSize: 12.5, fontWeight: 600, letterSpacing: "0.06em" }}>
                    Explore →
                  </span>
                </div>
              </Link>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          >
            <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: 36 }}>
              ...
              <p style={{ color: "rgba(232,245,238,0.72)", fontSize: 14.5, lineHeight: 1.65, fontWeight: 300, maxWidth: 420, marginBottom: 20 }}>
            ...
            {PILLARS.map((p) => (
              <div key={p.num} className="reveal">
                <GlassCard style={{ padding: 32, height: "100%" }}>
                  <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.18em", color: "#5AC8FF", marginBottom: 18 }}>
                    {p.num}
                  </div>
                  <h3 className="font-display" style={{ fontSize: "1.25rem", fontWeight: 600, color: "#fff", marginBottom: 12 }}>
                    {p.title}
                  </h3>
                  <p style={{ color: "rgba(232,245,238,0.62)", fontSize: 14.5, lineHeight: 1.7, fontWeight: 300 }}>
                    {p.desc}
                  </p>
                </GlassCard>
              </div>
      ...
      <section className="relative px-6 md:px-12 py-24" style={{ background: "#03130A" }}>
        <div className="max-w-4xl mx-auto reveal text-center">
          <div style={{ fontSize: 48, color: "#7AFFD4", lineHeight: 1, marginBottom: 16, fontFamily: "Georgia, serif" }}>“</div>
          <p
      ...
      <section className="relative px-6 md:px-12 py-24" style={{ background: "#03130A" }}>
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-24">
          <div className="lg:col-span-5 reveal" style={{
            backgroundImage: `linear-gradient(135deg, rgba(3,19,10,0.30) 0%, rgba(3,19,10,0.55) 100%), url("${PIPETTE_IMG}")`,
            backgroundSize: "cover", backgroundPosition: "center",
            borderRadius: 20, minHeight: 380, border: "1px solid rgba(122,255,212,0.12)",
          }} />
          <div className="lg:col-span-7 reveal">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 reveal lg:order-2 order-1" style={{
      ...
      {/* ─── FINAL CTA ─── */}
      <section className="relative px-6 md:px-12 py-32" style={{ background: "#03130A" }}>
        <div
          className="max-w-5xl mx-auto reveal relative overflow-hidden"
          style={{
            borderRadius: 24, padding: "72px 48px", textAlign: "center",
            background: "linear-gradient(135deg, rgba(20,52,36,0.85) 0%, rgba(8,28,18,0.95) 100%)",
        ...
        >
          ...
          <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.22em", color: "#7AFFD4", marginBottom: 20 }}>
            PARTNER WITH US
          </div>
          <h2
            className="font-display"
          ...
          <p style={{
            color: "rgba(232,245,238,0.70)", fontSize: "1.05rem", lineHeight: 1.7,
            fontWeight: 300, maxWidth: 520, margin: "0 auto 32px",
          }}>
          ...
          <Link href="/contact">
            <span
              className="cursor-pointer"
              style={{
                display: "inline-block", padding: "14px 30px", borderRadius: 999,
                background: "linear-gradient(135deg, #3EE6A8, #5AC8FF)",
                color: "#03130A", fontWeight: 700, fontSize: 14, letterSpacing: "0.02em",
                boxShadow: "0 8px 28px rgba(62,230,168,0.30)",
              }}
